...
void Coprocessor0::execute(const instruction_union& instruction)
{
...
// LWCz rt, offset(base)
void Coprocessor0::load_word_to_cop(const instruction_union& instr) 
{
...
// SWCz rt, offset(base)
void Coprocessor0::store_word_from_cop(const instruction_union& instr)
{
	unsigned int addr = (short)instr.immediate_instruction.immediate + (int)cpu->get_register(instr.immediate_instruction.rs);
...
// MTCz rt, rd
void Coprocessor0::move_to_cop(const instruction_union& instr)
{
...
// MFCz rt, rd
void Coprocessor0::move_from_cop(const instruction_union& instr)
{
...
// CTCz rt, rd
void Coprocessor0::move_control_to_cop(const instruction_union& instr)
{
	move_to_cop(instr);
}

// CFCz rt, rd
void Coprocessor0::move_control_from_cop(const instruction_union& instr)
{
	move_from_cop(instr);
}

// COPz cofun
void Coprocessor0::move_control_to_cop_fun(const instruction_union& instr)
{
	throw std::logic_error("not supported on cop0");
}

void Coprocessor0::move_to_cp0(const instruction_union& instr)
{
	move_to_cop(instr);
}

void Coprocessor0::move_from_cp0(const instruction_union& instr)
{
	move_from_cop(instr);
}

void Coprocessor0::read_indexed_tlb_entry(const instruction_union& instr)
{
	throw std::logic_error("not supported on cop0");
}

void Coprocessor0::write_indexed_tlb_entry(const instruction_union& instr)
{
	throw std::logic_error("not supported on cop0");
}

void Coprocessor0::write_random_tlb_entry(const instruction_union& instr)
{
	throw std::logic_error("not supported on cop0");
}

void Coprocessor0::probe_tlb_for_matching_entry(const instruction_union& instr)
{
	throw std::logic_error("not supported on cop0");
}

void Coprocessor0::restore_from_exception(const instruction_union& instr)
{
	throw std::logic_error("not supported on cop0");
}