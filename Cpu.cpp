...
// LWCz rt, offset(base)
void Cpu::load_word_to_cop(const instruction_union& instr)
{
	unsigned int cop_number = instr.immediate_instruction.op & 0x3;
	coprocessors[cop_number]->load_word_to_cop(instr);
}

// SWCz rt, offset(base)
void Cpu::store_word_from_cop(const instruction_union& instr)
{
	int cop_number = instr.immediate_instruction.op & 0x3;
	coprocessors[cop_number]->store_word_from_cop(instr);
}

// MTCz rt, rd
void Cpu::move_to_cop(const instruction_union& instr)
{
	int cop_number = instr.register_instruction.op & 0x3;
	coprocessors[cop_number]->move_to_cop(instr);
}

// MFCz rt, rd
void Cpu::move_from_cop(const instruction_union& instr)
{
	int cop_number = instr.register_instruction.op & 0x3;
...
// CTCz rt, rd
void Cpu::move_control_to_cop(const instruction_union& instr)
{
	int cop_number = instr.register_instruction.op & 0x3;
...
// CFCz rt, rd
void Cpu::move_control_from_cop(const instruction_union& instr)
{
	int cop_number = instr.register_instruction.op & 0x3;
...
// COPz cofun
void Cpu::move_control_to_cop_fun(const instruction_union& instr)
{
	unsigned int cop_number = instr.register_instruction.op & 0x3;
	coprocessors[cop_number]->move_control_to_cop_fun(instr);
}

// system control
// MTC0 rt, rd
void Cpu::move_to_cp0(const instruction_union& instr)
{
	throw std::logic_error("not implemented");
}

// MFC0 rt, rd
void Cpu::move_from_cp0(const instruction_union& instr)
{
	throw std::logic_error("not implemented");
}

// TLBR
void Cpu::read_indexed_tlb(const instruction_union& instr)
{
	throw std::logic_error("not implemented");
}

// TLBWI
void Cpu::write_indexed_tlb(const instruction_union& instr)
{
	throw std::logic_error("not implemented");
}

// TLBWR
void Cpu::write_random_tlb(const instruction_union& instr)
{
	throw std::logic_error("not implemented");
}

// TLBP
void Cpu::probe_tlb_for_matching_entry(const instruction_union& instr)
{
	throw std::logic_error("not implemented");
}

//RFE
void Cpu::restore_from_exception(const instruction_union& instr)
{
	throw std::logic_error("not implemented");
}